...
Only requiring some minor changes is nero.cpp.
...
Changes to nero.cpp
----------------------
nero.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
