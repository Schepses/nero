...
This mechanism has been integrated into Bitcore-Node-Nero which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nero/insight-api-nero#web-socket-api](https://github.com/nero/insight-api-nero#web-socket-api)
* API: [https://github.com/nero/insight-api-nero#instantsend-transactions](https://github.com/nero/insight-api-nero#instantsend-transactions)
...
By default, the Nero Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nero Core daemon:
