 ...
 *
 *   // network
 *   CNeroNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.nero.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNeroNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: NeroNetwork
// //   -- signature requirements : Key1(User)
// class CNeroNetworkVariable : public CGovernanceObject
// {
// private:
