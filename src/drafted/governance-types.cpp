...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NeroNetwork") type = NeroNetwork;
    if(strType == "NeroNetworkVariable") type = NeroNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NeroNetwork) s = "NeroNetwork";
    if(type == NeroNetworkVariable) s = "NeroNetworkVariable";
