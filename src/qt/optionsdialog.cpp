    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NERO-light"), QVariant("light"));
    ui->theme->addItem(QString("NERO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("NERO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NERO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NERO-traditional"), QVariant("trad"));
