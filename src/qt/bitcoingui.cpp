    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Nero Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nero address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nero: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Nero Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nero Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nero Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nero addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nero addresses"));
    ...
    openAction->setStatusTip(tr("Open a nero: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nero Core help message to get a list with possible Nero Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Nero Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nero network", "", count));
    } else {
...
{
    QString strTitle = tr("Nero Core"); // default title
