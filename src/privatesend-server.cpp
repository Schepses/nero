...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Nero related functionality
...
/*
    ...
    allow endless transaction that would bloat Nero and make it unusable. To
